package nio.springserver.mthreads.progress;
 ...
 * <p>
 * This class is intended for use by the currently executing Eclipse
 * application. Plug-ins outside the currently running application should not
 * reference or subclass this class.
 * </p>
 * 
...
public abstract class ProgressProvider {
	 ...
	 * @return a progress monitor, or <code>null</code> if no progress
	 ...
	 * progress feedback on a set of running jobs. This method implements
	 ...
	 * progress in the context of a progress group. This method implements
	 * <code>Job.setProgressGroup</code>. One of the two
	 * <code>createMonitor</code> methods will be invoked prior to each
	 * execution of a job, depending on whether a progress group was specified
	 * for the job.
	 * <p>
	 * The provided monitor must be a monitor returned by the method
	 * <code>createProgressGroup</code>. This method is responsible for
	 * asserting this and throwing an appropriate runtime exception if an
	 * invalid monitor is provided.
	 * <p>
	 * This default implementation returns a new <code>SubProgressMonitor</code>
	...
	/**
	 * Returns a progress monitor to use when none has been provided by the
	 * client running the job.
	 * <p>
	 * This default implementation returns a new
	 * <code>NullProgressMonitor</code> Subclasses may override.
	 * 
