...
public class Status implements IStatus {
     ...
     * @since 3.0
     */
    public static final IStatus OK_STATUS = new Status(OK, unknownId, OK, "ok", null);
    /**
     * A standard CANCEL status with no message.
     * 
     * @since 3.0
     */
    public static final IStatus CANCEL_STATUS = new Status(CANCEL, unknownId, 1, "", null);
    /**
     * The severity. One of
     * <ul>
     ...
     */
    public Status(int severity, String processName, int code, String message, Throwable exception) {
