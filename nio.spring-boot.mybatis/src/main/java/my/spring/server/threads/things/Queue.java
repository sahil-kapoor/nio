...
public class Queue {
     ...
     * reference when you remove it from the queue. If reuse is false the queue
     * no longer holds a reference to the object when it is removed. If reuse is
     * true you can use the method getNextAvailableObject to get an used object,
     * set its new values and add it again to the queue.
     */
    ...
    /**
     * This method does not affect the queue itself. It is only a helper to
     * decrement an index in the queue.
     */
	...
	// if objects are reused, transfer the reference that is removed to the
	// end of the queue
	// otherwise set the element after the last one to null (to avoid
    ...
    /**
     * This method does not affect the queue itself. It is only a helper to
     * increment an index in the queue.
     */
